...
#Creating VNet & Subnet for the VM
resource "azurerm_virtual_network" "vnet" {
  name                = "vnet-iam-homelab"
...
#Deallocation rule
resource "azurerm_dev_test_global_vm_shutdown_schedule" "dc1_shutdown" {
